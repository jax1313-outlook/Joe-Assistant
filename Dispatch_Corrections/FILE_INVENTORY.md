...
Every file this work created or changed, with a short hash so the package can be
checked against a checkout. Generated from `git`, not written by hand.

## Sandbox — `jax1313-outlook/Joe-Assistant`
...
### `Assistant_Plugin/voice/providers.py` — Which voice this machine has

| File | Lines | sha256 |
|---|---|---|
| `Assistant_Plugin/voice/providers.py` | 212 | `1f2fe53e1cd7` |

### `Assistant_Plugin/tests/` — Joe and M365 tests

| File | Lines | sha256 |
|---|---|---|
| `Assistant_Plugin/tests/test_conversation.py` | 431 | `59efe3025820` |
| `Assistant_Plugin/tests/test_field_capture.py` | 273 | `b4523e8e6b3a` |
| `Assistant_Plugin/tests/test_joe.py` | 3756 | `5dee9f45b3e5` |
| `Assistant_Plugin/tests/test_listening_stops.py` | 70 | `3c02a452ff8d` |
| `Assistant_Plugin/tests/test_m365.py` | 321 | `de06203b5761` |
| `Assistant_Plugin/tests/test_misheard_freight.py` | 121 | `0cffb9bcfe33` |
| `Assistant_Plugin/tests/test_opportunity_loop.py` | 141 | `5c4f56819d4e` |
| `Assistant_Plugin/tests/test_opportunity_parser.py` | 31 | `df1174a6a17a` |
...
### `pytest.ini` — Which suites, and which archived copies are not collected
...
| # | Patch | Lines | sha256 |
|---|---|---|---|
| 0001 | `0001-Repair-the-operational-proof-path-and-make-it-execut.patch` | 685 | `b7b95490eb32` |
| 0002 | `0002-Build-the-schema-once-per-process-wait-for-a-write-l.patch` | 262 | `3b8827a8b2c3` |
| 0003 | `0003-Replace-the-dashboard-s-per-load-queries-with-two-ro.patch` | 472 | `572d56154c1a` |
| 0004 | `0004-Make-multi-step-service-operations-atomic-and-defer-.patch` | 607 | `21164f9224d9` |
| 0005 | `0005-Move-the-PIN-lockout-counters-where-a-transaction-pr.patch` | 730 | `98cbcbe123fe` |
| 0006 | `0006-Money-becomes-whole-cents-exactly-everywhere-it-is-a.patch` | 972 | `cde1cf53da71` |
| 0007 | `0007-Give-the-operator-a-way-to-take-a-backup-and-to-prov.patch` | 1126 | `cc650bfa995f` |
| 0008 | `0008-Put-a-provider-neutral-transport-behind-the-mail-pat.patch` | 2162 | `8e64b8170b89` |
| 0009 | `0009-Record-every-outbound-attempt-log-it-and-give-the-lo.patch` | 1415 | `aefd6716b28a` |
| 0010 | `0010-Wire-the-capacity-engine-into-production-and-make-ap.patch` | 1645 | `0d6eb971b117` |
| 0011 | `0011-Measure-branch-coverage-and-measure-the-launcher.patch` | 133 | `fda98059130c` |
| 0012 | `0012-Record-what-governs-this-repository-and-adjudicate-t.patch` | 167 | `599ba7be3e88` |
