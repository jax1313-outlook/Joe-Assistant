# GOVERNANCE — what actually governs Joe-Assistant
...
- **`READ ME.md`** — This repository is the proving ground, not production.
  <br>States its own promotion path: Test-Grounds -> Review -> Hold -> Review -> Dispatch. It is why work lands here first.
...
```
python -m dispatch_governance show Joe-Assistant
