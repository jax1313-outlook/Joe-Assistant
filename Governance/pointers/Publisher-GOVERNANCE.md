# GOVERNANCE — what actually governs Publisher
...
- **`README.md`** — What the Publisher worker is and what it may do, inside its own repository.
...
```
python -m dispatch_governance show Publisher
